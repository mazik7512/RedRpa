from Modules.Core.Abstract.Crypto.Hasher import AbstractHasher
import ctypes
from AppData.Configs.CryptoConfig import STRIBOG_DLL_PATH
from AppData.Configs.CryptoConfig import HASH_SIZE
import sys
