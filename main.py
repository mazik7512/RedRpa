...
if __name__ == "__main__":
    ...
    scenario = "function inner_loop(a, b){ a = b = 5; } loop(){} CV_scan(get_window(get_name()), \"button\"); click_on_object(); loop(a){ loop(b){ inner_loop(); inner_loop_1(); } outer_loop_1(); outer_loop2(); } outside_loop();"
