from RRPA.Modules.Core.Abstract.Network.Protocols.NetworkObjects import AbstractReceiveObject
from RRPA.Modules.Core.Abstract.Network.Protocols.NetworkObjects import AbstractSendObject
