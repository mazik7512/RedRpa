...
class ServerModel:
    ...
    def hash_app(self, client_path):
        client_app_files = self.__get_server_app_files(client_path)
        client_app_files_data = self.__get_server_app_files_data(client_app_files)
        return hex(self._hasher.hash_string(client_app_files_data))[2:]

    def __get_server_app_files_data(self, app_files):
        data = ""
    ...
    def __get_server_app_files(self, path):
        app_files = []
