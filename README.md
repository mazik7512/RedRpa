...
Здесь может представлять интерес только операция "Обновление сессионых ключей" данный протокол предназначен для запуска алгоритма описанного ранее в пункте ["Шифрование"](#ядро-sdk-шифрование), начиная с пункта 2.
