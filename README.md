...
Класс **Window** предоставляет возможности для работы с окном, как с объектом операционной системы, а не окном для RedRPA фреймворка, в свою же очередь Window Manager, наоборот предоставляет интерфейс для взаимодействия с окном «в стиле» RedRPA фреймворка. Он хранит в себе пул найденных в окне объектов (Win Objects), а также предоставляет функции для использования их внутри API – библиотек языка RSL.
